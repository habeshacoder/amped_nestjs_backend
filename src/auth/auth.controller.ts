...
export class AuthController{
    ...
    @HttpCode(HttpStatus.OK)
    @Patch('reset_password_phone')
    resetPhone (@Body() dto: ResetPhoneDto) {
        return this.authService.resetPhone(dto);
    }
    ...
    @HttpCode(HttpStatus.OK)
    @Post('verify_google_auth')
    verifyGoogleToken(@Req() req){
        return this.authService.verifyGoogleAuth(req);
    }
    ...
    @HttpCode(HttpStatus.OK)
    @Post('facebookPhone')
    facebookPhone (@Req() req) {
        return this.authService.facebookAuthPhone(req);
    }
