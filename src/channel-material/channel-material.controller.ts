...
import { Controller, Get, Post, Body, Patch, Param, Delete, UseGuards, HttpCode, HttpStatus, UseInterceptors, UploadedFile, Res, ParseFilePipeBuilder, UploadedFiles, Query } from '@nestjs/common';
...
export class ChannelMaterialController {
    constructor(private readonly channelMaterialService: ChannelMaterialService) {}
    ...
    updateMaterial(@Param('id') id: string, @UploadedFiles() files: {material: Express.Multer.File}) {//, profile: Express.Multer.File, cover: Express.Multer.File, images: Express.Multer.File, preview: Express.Multer.File}) {
    ...
    updateMaterialProfile(@Param('id') id: string, @UploadedFiles() files: {profile: Express.Multer.File}) {//, profile: Express.Multer.File, cover: Express.Multer.File, images: Express.Multer.File, preview: Express.Multer.File}) {
    ...
    updateMaterialCover(@Param('id') id: string, @UploadedFiles() files: {cover: Express.Multer.File}) {//, profile: Express.Multer.File, cover: Express.Multer.File, images: Express.Multer.File, preview: Express.Multer.File}) {
    ...
    updateMaterialImage(@Param('id') id: string, @UploadedFiles() files: {images: Express.Multer.File}) {//, profile: Express.Multer.File, cover: Express.Multer.File, images: Express.Multer.File, preview: Express.Multer.File}) {
    ...
    updateMaterialPreview(@Param('id') id: string, @UploadedFiles() files: {preview: Express.Multer.File}) {//, profile: Express.Multer.File, cover: Express.Multer.File, images: Express.Multer.File, preview: Express.Multer.File}) {
    ...
    getMaterial(@Param('fileName') fileName, @Res() res) {
        return (res.sendFile(join(process.cwd(), 'uploads/channel/material/' + fileName)));
    }
    ...
    getMaterialImage(@Param('imageName') imageName, @Res() res) {
        return (res.sendFile(join(process.cwd(), 'uploads/channel/material/' + imageName)));
    }
