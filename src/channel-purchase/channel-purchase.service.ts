...
//         try {
//             const unfinishedOrderChannel = await this.prisma.unfinishedOrderChannel.create({
//                 data: {
//                     tx_ref: tx_ref,
//                     user_id: user.id,
//                     price: +dto.price,
...
//                         tx_ref: tx_ref,
//                         callback_url: 'https://localhost:3000/channel-purchase/verify/' + tx_ref,
//                         return_url: dto.return_url,
//                         'customization[title]': 'Payment from AratKillo',
//                         'customization[description]': 'add the channel name and the plan here.',
//                     }),
//                 };
